<template>
	...
	>
		<el-form :model="dataForm" ref="dataForm" :rules="dataRule" label-width="80px">
			...
			<el-form-item v-if="dataForm.id" label="状態">
				<el-select v-model="dataForm.status" class="input" placeholder="状態" size="medium">
					<el-option label="使用可" value="1" />
					<el-option label="使用不可" value="0" />
				</el-select>
			</el-form-item>
		</el-form>
		<template #footer>
